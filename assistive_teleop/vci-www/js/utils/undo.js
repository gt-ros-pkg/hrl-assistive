var RFH = (function (module) {
    module.UndoEntry = function (options) {
        'use strict';
        options = options || {};
        var self = this;   
    ...
    module.Undo = function (options) {
        ...
        var torso = options.torso || new RFH.PR2Torso(ros);
        var rGripper = options.rGripper || new RFH.PR2GripperSensor({side:'right', ros:ros});
        var lGripper = options.lGripper || new RFH.PR2GripperSensor({side:'left', ros:ros});
        var head = options.head || new RFH.PR2Head({ros: ros,
        ...
        var rArm = options.rArm || new RFH.PR2ArmMPC({side:'right',
                                                  ros: ros,
        ...
        var lArm = options.rArm || new RFH.PR2ArmMPC({side:'left',
                                                  ros: ros,
