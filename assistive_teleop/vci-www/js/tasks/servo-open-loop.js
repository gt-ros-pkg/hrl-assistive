RFH.ServoOpenLoop = function (options) {
    "use strict";
    var self = this;
    options = options || {};
    self.showButton = true;
    self.buttonText = 'Servoing';
    self.buttonClass = 'servo-button';
    self.toolTipText = "Drive the robot";
    self.name = options.name || 'servoOpenLoopTask';
    ...
    var updateGoalVisualization = function () {
        if (odomCombinedTF === null || goalPose === null) { return; };
...
//        odomCombinedMat.getInverse(odomCombinedMat);
    ...
    var updateGoal = function (psMsg) {
        goalPose = psMsg;
        updateGoalVisualization();
    };
    goalSub.subscribe(updateGoal);
