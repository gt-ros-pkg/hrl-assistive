"""autogenerated by genpy from assistive_teleop/LookatIkRequest.msg. Do not edit."""
import sys
...
class LookatIkRequest(genpy.Message):
  _md5sum = "47dfdbd810b48d0a47b7ad67e4191bcc"
  _type = "assistive_teleop/LookatIkRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LookatIkRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from assistive_teleop/LookatIkResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class LookatIkResponse(genpy.Message):
  _md5sum = "de47a777eb537c923ae58f19a92ba611"
  _type = "assistive_teleop/LookatIkResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['joint_names','joint_angles']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LookatIkResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_I = genpy.struct_I
class LookatIk(object):
  _type          = 'assistive_teleop/LookatIk'
  _md5sum = 'fb8536aa2bfd1d1ca15fb0dd97404163'
  _request_class  = LookatIkRequest
  _response_class = LookatIkResponse
