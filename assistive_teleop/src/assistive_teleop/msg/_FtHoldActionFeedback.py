"""autogenerated by genpy from assistive_teleop/FtHoldActionFeedback.msg. Do not edit."""
import sys
...
class FtHoldActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "assistive_teleop/FtHoldActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','assistive_teleop/FtHoldFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FtHoldActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = assistive_teleop.msg.FtHoldFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = assistive_teleop.msg.FtHoldFeedback()
