...
class ServoingManager(object):
    ...
    def ell_cb(self, ell_msg):
        ...
        self.head_pose.header = copy.copy(ell_msg.e_frame.header)
        self.head_pose.pose.position.x = ell_msg.e_frame.transform.translation.x
        self.head_pose.pose.position.y = ell_msg.e_frame.transform.translation.y
        self.head_pose.pose.position.z = ell_msg.e_frame.transform.translation.z
        self.head_pose.pose.orientation.x = ell_msg.e_frame.transform.rotation.x
        self.head_pose.pose.orientation.y = ell_msg.e_frame.transform.rotation.y
        self.head_pose.pose.orientation.z = ell_msg.e_frame.transform.rotation.z
        self.head_pose.pose.orientation.w = ell_msg.e_frame.transform.rotation.w
