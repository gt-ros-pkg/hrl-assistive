...
from hrl_head_registration.srv import HeadRegistration, HeadRegistrationResponse
...
class RegistrationLoader(object):
    ...
    def __init__(self):
        ...
        self.confirm_reg_srv = rospy.Service("/confirm_registration", Empty, self.confirm_reg_cb)
    ...
    def init_reg_cb(self, req):
        ...
        return HeadRegistrationResponse(tf_pose=self.head_reg_pose)
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        if rl.head_frame_tf is not None:
            rl.head_frame_bcast.sendTransfrom(rl.head_frame_tf[0],
                                              rl.head_frame_tf[1],
                                              rospy.Time.now(),
                                              rl.HEAD_FRAME,
                                              rl.WORLD_FRAME)
