...
def getFeeding(task, data_renew, HMM_renew, CF_renew, rf_center='kinEEPos',local_range=10.0, \
    ...
    HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 3.0, 'scale': [7.0, 15.0],\
                      'add_logp_d': False }
    SVM_param_dict = {'renew': CF_renew,\
                      'logp_offset': 0.,\
                      'nugget': 30.0, 'theta0': 1.0,\
                      'std_offset': 1.4464
                      }
    ...
    ROC_param_dict = {'nPoints': nPoints,\
                      ...
                      'hmmgp0_param_range': np.logspace(0.8, 2.0, nPoints)*-1.0+0.5,\
                      'hmmgp1_param_range': np.logspace(0.8, 2.0, nPoints)*-1.0+0.5}
