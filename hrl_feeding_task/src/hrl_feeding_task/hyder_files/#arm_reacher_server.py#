...
class armReachAction(mpcBaseAction):
    def __init__(self, d_robot, controller, arm = 'l'):
        ...
        rospy.Subscriber('bowl_location', Pose, self.bowlPoseCallback)
    ...
    def bowlPoseCallback(self, data):
        self.bowl_pos = np.matrix([ [data.position.x], [data.position.y], [data.position.z] ])
        self.bowl_quat = np.matrix([ [data.orientation.x], [data.orientation.y], [data.orientation.z], [data.orientation.w] ])
	...
	#Flat Gripper Rotation Values:
	#(0.642, 0.150, 0.154, 0.736)

        print "MOVES1"
        (pos.x, pos.y, pos.z) = (self.bowl_pos[0] + -0.2920, self.bowl_pos[1] + -0.7260, self.bowl_pos[2] + 0.2600)
        (quat.x, quat.y, quat.z, quat.w) = (0.740, 0.052, -0.100, 0.663)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) # (0.573, -0.451, -0.534, 0.428)
        timeout = 1.0
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.740, 0.052, -0.100, 0.663)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.690, -0.092, -0.112, 0.709)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.601, 0.397, -0.412, 0.558)  #  (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.713, 0.064, -0.229, 0.659)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.601, 0.397, -0.412, 0.558)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.700, 0.108, -0.321, 0.629)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.700, 0.201, -0.229, 0.646)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.706, 0.068, -0.235, 0.664)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.740, 0.052, -0.100, 0.663)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.672, 0.037, -0.137, 0.727)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.740, 0.052, -0.100, 0.663)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.699, -0.044, -0.085, 0.709)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
        ...
        (quat.x, quat.y, quat.z, quat.w) = (0.740, 0.052, -0.100, 0.663)  # (self.bowl_quat[0], self.bowl_quat[1], self.bowl_quat[2], self.bowl_quat[3]) #  (0.677, -0.058, -0.004, 0.733)
        timeout = 1.0
        self.setOrientGoal(pos, quat, timeout)
        raw_input("Enter anything to start: ")
