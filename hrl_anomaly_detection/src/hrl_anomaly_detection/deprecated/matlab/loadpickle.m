function [a] = loadpickle(filename)
    ...
    pyscript = ['import cPickle as pickle;import sys;import scipy.io;import numpy;file=open("' filename '","r");dat=pickle.load(file);file.close();scipy.io.savemat("' outname '",dat)'];
