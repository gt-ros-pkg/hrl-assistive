...
def getFeeding(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, ae_swtch=False, dim=4):
    ...
    if dim == 4:
        ...
        ROC_param_dict = {'methods': ['fixed', 'progress_time_cluster', 'hmmosvm', 'svm', 'change', 'hmmsvm_diag', 'hmmsvm_dL', 'hmmsvm_LSLS', 'bpsvm'],\
                          'update_list': [ 'hmmosvm'],\
                          'nPoints': nPoints,\
                          ...
                          'hmmosvm_param_range': np.linspace(0,10.0,nPoints),\
...
def getPushingMicroBlack(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False,\
    ...
    if dim == 5:
        ...
        ROC_param_dict = {'methods': ['progress_time_cluster', 'svm', 'fixed', 'change', 'hmmsvm_dL', 'hmmosvm', 'hmmsvm_diag', 'hmmsvm_LSLS', 'bpsvm' ],\
                          'update_list': [ 'hmmosvm' ],\
                          'nPoints': nPoints,\
