...
def getScooping(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False,\
    ...
    if dim == 4:
        ...
        ROC_param_dict = {'methods': [ 'change', 'fixed', 'progress_time_cluster', 'svm', 'progress_state'],\
                          'update_list': ['osvm', 'svm', 'progress_state'],\
                          'nPoints': nPoints,\
...
def getPushingToolCase(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        ROC_param_dict = {'methods': [ 'progress_time_cluster', 'svm', 'fixed', 'change', 'osvm', 'hmmsvm_dL', 'hmmosvm', 'hmmsvm_diag', 'hmmsvm_LSLS', 'bpsvm', 'progress_state' ],\
                          'update_list': [ 'progress_state' ],\
                          'nPoints': nPoints,\
