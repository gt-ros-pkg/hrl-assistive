...
def getPushingMicroWhite(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 1.366, 'scale': 5.0}
        ...
        if ae_swtch:
            ...
            HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 1.78, 'scale': 8.0}
...
def getPushingMicroBlack(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False,\
    ...
    if dim == 5:
        ...
        if ae_swtch:
            ...
            HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 10.0, 'scale': 6.0, \
                              'add_logp_d': True}
            SVM_param_dict = {'renew': False, 'w_negative': 0.211, 'gamma': 1.444, 'cost': 3.0}
        ...
        handFeatures = ['unimodal_ftForce',\
                        'crossmodal_artagEEDist',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 1., 'scale': 7.0, \
                          'add_logp_d': True}
        SVM_param_dict = {'renew': False, 'w_negative': 0.599, 'gamma': 1.0, 'cost': 3.0}
        ...
        handFeatures = ['unimodal_ftForce',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 7.75, 'scale': 6.5}
        SVM_param_dict = {'renew': False, 'w_negative': 0.325, 'gamma': 2.0, 'cost': 5.0}
