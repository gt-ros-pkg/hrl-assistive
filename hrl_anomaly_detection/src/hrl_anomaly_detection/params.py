...
def getScooping(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False,\
    ...
    if dim == 4:
        ...
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 3.666, 'scale': 7.333,
                          'add_logp_d': False}
        ...
        ROC_param_dict = {'methods': [ 'fixed', 'change', 'progress', 'progress_state', 'osvm', 'progress_diag', ],\
                          'update_list': [ ],\
                          'nPoints': nPoints,\
                          'progress_param_range':np.logspace(-0.5, 1.3, nPoints)*-1.0, \
                          'progress_diag_param_range':np.logspace(-0.7, 1.3, nPoints)*-1.0, \
                          'progress_state_param_range':np.logspace(0, 2., nPoints)*-1+3.0, \
                          'progress_svm_param_range': np.linspace(0.005, 14.0, nPoints),\
                          ...
                          'change_param_range': np.logspace(0.0, 1.8, nPoints)*-1.0,\
                          'fixed_param_range': np.linspace(-0.841, 0.292, nPoints),\
        ...
        ROC_param_dict = {'methods': [ 'fixed', 'progress', 'kmean'],\
                          ...
                          'fixed_param_range': np.linspace(0.135, -0.43, nPoints),\
                          'cssvm_param_range': np.logspace(-4.0, 2.0, nPoints),\
                          'hmmosvm_param_range': np.logspace(-4.0, 0.5, nPoints),\
                          'change_param_range': np.logspace(0.0, 1.1, nPoints)*-1.0,\
...
<<<<<<< HEAD
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 5.0, 'scale': 10.0, \
=======
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 1.0, 'scale': 7.66, \
>>>>>>> 1626e39d23e1e5a995cbfba80255433d46eacedd
                          'add_logp_d': False}
        ...
        ROC_param_dict = {'methods': [ 'fixed', 'change', 'progress', 'progress_state', 'osvm', 'progress_diag', ],\
                          'update_list': [  ],\
                          'nPoints': nPoints,\
                          'progress_param_range': -np.logspace(-2, 1.5, nPoints),\
                          'progress_diag_param_range': -np.logspace(-3., 1.6, nPoints),\
                          'kmean_param_range': -np.logspace(0., 1.3, nPoints)+1.0,\
                          'progress_state_param_range':np.linspace(0, -60., nPoints), \
                          'progress_svm_param_range': np.linspace(0.005, 14.0, nPoints),\
                          'progress_osvm_param_range': np.logspace(-6.0, 1.0, nPoints),\
                          ...
                          'hmmosvm_param_range': np.logspace(-2,-1,nPoints),\
                          'change_param_range': np.logspace(0.0, 1.4, nPoints)*-1.0,\
                          'osvm_param_range': np.logspace(-5., 0.0, nPoints),\
                          'bpsvm_param_range': np.logspace(-2.2, 0.5, nPoints),\
                          'fixed_param_range': np.linspace(0.247, -1.0, nPoints),\
...
def getPushingMicroWhite(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        ROC_param_dict = {'methods': [ 'change','fixed','progress', 'progress_state', \
                          ...
                          'update_list': [ ],\
                          'nPoints': nPoints,\
                          'progress_param_range':np.logspace(0, 1.1, nPoints)*-1.0, \
        ...
        ROC_param_dict = {'methods': ['fixed', 'progress', 'kmean'],\
                          ...
                          'fixed_param_range': np.linspace(1.0, -2.75, nPoints),\
                          'cssvm_param_range': np.logspace(-4.0, 2.0, nPoints),\
        ...
        ROC_param_dict = {'methods': ['fixed', 'progress', 'kmean'],\
                          ...
                          'change_param_range': np.logspace(-1, 0.5, nPoints)*-1.0,\
...
def getPushingMicroBlack(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False,\
    ...
    if dim == 5:
        ...
        ROC_param_dict = {'methods': [ 'fixed', 'progress', 'kmean'],\
                          ...
                          'change_param_range': np.logspace(-1, 0.7, nPoints)*-1.0,\
        ...
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 4.5, 'scale': 7.333, \
                          'add_logp_d': False}
...
def getPushingToolCase(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        ROC_param_dict = {'methods': [ 'fixed', 'progress', 'kmean' ],\
                          ...
                          'change_param_range': np.logspace(0.0, 1.5, nPoints)*-1.0,\
                          'cssvm_param_range': np.logspace(-4.0, 2.0, nPoints) }        
    elif dim == 4:
        handFeatures = ['unimodal_ftForce',\
                        'crossmodal_artagEEDist',\
        ...
        handFeatures = ['unimodal_ftForce',\
                        'crossmodal_artagEEDist',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 12.0, 'scale': 6.75, \
                          'add_logp_d': False}
