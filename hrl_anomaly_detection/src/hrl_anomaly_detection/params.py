...
def getPushingMicroWhite(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        SVM_param_dict = {'renew': False, 'w_negative': 1.0, 'gamma': 0.173, 'cost': 4.0}
        ...
        handFeatures = ['unimodal_ftForce',\
                        ...
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        if ae_swtch:
            SVM_param_dict = {'renew': False, 'w_negative': 1.0, 'gamma': 2.0, 'cost': 4.0}
            HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 1.36, 'scale': 3.25}
        else:
            SVM_param_dict = {'renew': False, 'w_negative': 1.0, 'gamma': 2.0, 'cost': 4.0}
            HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 2.0, 'scale': 7.75}
        ...
        handFeatures = ['unimodal_ftForce',\
                        'crossmodal_artagEEDist',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        SVM_param_dict = {'renew': False, 'w_negative': 0.7, 'gamma': 1.5, 'cost': 3.0}
        ...
        handFeatures = ['unimodal_ftForce',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        SVM_param_dict = {'renew': False, 'w_negative': 1.0, 'gamma': 2.0, 'cost': 4.0}
        HMM_param_dict = {'renew': HMM_renew, 'nState': 35, 'cov': 0.73, 'scale': 10.0}
...
def getPushingToolCase(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False, \
    ...
    if dim == 5:
        ...
        handFeatures = ['unimodal_ftForce',\
                        ...
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        SVM_param_dict = {'renew': False, 'w_negative': 6.0, 'gamma': 0.173, 'cost': 4.0}
        HMM_param_dict = {'renew': HMM_renew, 'nState': 20, 'cov': 4, 'scale': 4}
        ...
        handFeatures = ['unimodal_ftForce',\
                        ...
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        SVM_param_dict = {'renew': False, 'w_negative': 6.0, 'gamma': 0.173, 'cost': 4.0}
        HMM_param_dict = {'renew': HMM_renew, 'nState': 25, 'cov': 4.0, 'scale': 0.01}
    elif dim == 2:
        handFeatures = ['unimodal_ftForce',\
                        'unimodal_audioWristRMS'] #'unimodal_audioPower', ,
        SVM_param_dict = {'renew': False, 'w_negative': 6.0, 'gamma': 0.173, 'cost': 4.0}
        HMM_param_dict = {'renew': HMM_renew, 'nState': 20, 'cov': 4, 'scale': 4}
        ## HMM_param_dict = {'renew': HMM_renew, 'nState': 20, 'cov': 1.67, 'scale': 0.01}
