...
def getPushingMicroWhite(task, data_renew, AE_renew, HMM_renew, rf_center,local_range, pre_train=False):
    ...
    ROC_param_dict = {'methods': [ 'progress_time_cluster', 'svm', 'cssvm' ],\
                      'update_list': ['cssvm'],\
                      'nPoints': nPoints,\
...
def getPushingMicroBlack(task, data_renew, AE_renew, HMM_renew, rf_center,local_range):
    ...
    if filterDim==3: 
        ...
        layers = [64,8]
        ## add_option = ['audioWristRMS']
        add_option = ['ftForce_mag','audioWristRMS','targetEEDist', 'targetEEAng']
        add_noise_option = ['ftForce_mag']
