...
rosrun xacro xacro ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin.urdf.xacro > ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin.URDF
rosrun xacro xacro ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin_openrave.urdf.xacro > ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin_openrave.URDF
# Generate dae from URDF
...
rosrun collada_urdf urdf_to_collada ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin.URDF ./collada/bed_and_environment_mannequin.dae
rosrun collada_urdf urdf_to_collada ./urdf/bed_and_environment_mannequin/robots/bed_and_environment_mannequin_openrave.URDF ./collada/bed_and_environment_mannequin_openrave.dae
...
rosrun hrl_gazebo_darci round_collada_numbers.py ./collada/bed_and_environment_mannequin_openrave.dae ./collada/bed_and_environment_mannequin_openrave_rounded.dae 3
