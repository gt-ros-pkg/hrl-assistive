...
class HeadGlobalTFBroadcaster(object):
    ...
    def ar_tag_head_cb(self, msg):
        ...
        self.tf_listener.waitForTransform('odom_combined', 'torso_lift_link', now, rospy.Duration(1))
        (newtrans, newrot) = self.tf_listener.lookupTransform('odom_combined', 'torso_lift_link', now)
