                    ...
                    for profile in mat[sub][vel][e]:
                        if accum_num < training_part[e][0] or accum_num >= training_part[e][1]:
                            if vel == 0:
                                ...
                                trains[e].append(warped_data[0:perc, datafrom:datato])
                            else:
                                ...
                                trains[e].append(profile[0:perc, datafrom:datato])
                        else:
...
def run_crossvalidation(Fmat, categories, n_folds, test_percentages, train_percentage):
    ...
    for fold in range(1, n_folds+1):
        training_set, testing_set, training_trials, testing_trials = create_datasets(Fmat, fold, n_folds, 'subject', train_percentage)
