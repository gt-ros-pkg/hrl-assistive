...
class ForceDataFormatting(object):
            ...
            for ind_j in xrange(len(result[0])):
                if result[ind_i][ind_j] is not None:
                    ...
                    if not ft_threshold_was_exceeded:
                        this_label = 'missed'
                    elif abs(position_of_stop - success_position_of_stop) < 0.02 or position_of_stop >= success_position_of_stop:
                        this_label = 'good'
                    else:
    ...
    def set_position_data_from_saved_movement_profile(self, subject, result):
        # print subject
        # print result
