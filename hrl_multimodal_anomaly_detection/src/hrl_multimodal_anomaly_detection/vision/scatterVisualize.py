...
for i in xrange(9):
    xs, ys, zs, ts, distances, angles, times = plot3dPoints('/home/zerickson/Recordings/trainingDataVer1_scooping_fvk_07-14-2015_11-06-33/iteration_%d_success.pkl' % i)
    xss, yss, zss, tss, distances2, angles2, times2 = plot3dPoints('/home/zerickson/Recordings/trainingDataVer1_scooping_fvk_07-14-2015_11-06-33/iteration_%d_success.pkl' % (i+1))
