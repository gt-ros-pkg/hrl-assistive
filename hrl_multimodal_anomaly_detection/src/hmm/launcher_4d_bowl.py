...
def trainMultiHMM():
    fileName = os.path.join(os.path.dirname(__file__), 'data/bowl2Data3.pkl')
    ...
    hmm.fit(xData1=forcesSample, xData2=distancesSample, xData3=anglesSample, xData4=pdfSample, ml_pkl='modals/ml_4d_bowl2_3.pkl', use_pkl=True)
