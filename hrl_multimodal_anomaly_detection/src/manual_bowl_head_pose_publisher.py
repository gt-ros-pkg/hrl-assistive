...
class bowlPublisher:
	def __init__(self):
		...
		(self.bowl_pose_manual.pose.position.x, 
			...
			self.bowl_pose_manual.pose.position.z) = (0.928, 0.263, -0.314) # 0.928, 0.263, -0.314 | 0.836, 0.496, -0.322 | 0.880, -0.007, -0.305
		...
		(self.head_pose_manual.pose.position.x,
			...
			self.head_pose_manual.pose.position.z) = (0.689, -0.234, 0.120)
