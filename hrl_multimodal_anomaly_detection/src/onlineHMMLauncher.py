...
def setupMultiHMM():
    fileName = os.path.join(os.path.dirname(__file__), 'onlineDataNorm.pkl')
    ...
    hmm.fit(xData1=forcesSample, xData2=distancesSample, xData3=anglesSample, xData4=pdfSample, ml_pkl='../ml_4d_online_norm.pkl', use_pkl=True)
