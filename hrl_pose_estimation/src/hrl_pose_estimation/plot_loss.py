...
class DataVisualizer():
    ...
    def __init__(self, pkl_directory):
        ...
        plt.plot(train_val_loss['epoch_flip_shift_nd_nohome_1000e_1'], train_val_loss['train_flip_shift_nd_nohome_1000e_1'], 'b')
        plt.plot(train_val_loss['epoch_flip_shift_nd_nohome_1000e_1'], train_val_loss['val_flip_shift_nd_nohome_1000e_1'], 'r')
